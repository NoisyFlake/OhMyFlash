#include "OhMyFlashPrefs.h"

@implementation OhMyFlashPrefs
...
- (id)initWithSpecifier:(PSSpecifier *)specifier
{
	...
	if (self) {
		...
		background.backgroundColor = [UIColor colorWithRed:0.96 green:0.26 blue:0.43 alpha:1.0];
